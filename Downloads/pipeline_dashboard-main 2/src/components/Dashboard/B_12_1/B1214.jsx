...
const casingData = [
  { section: "Casing", size: '30"',       fromMD: 0,      toMD: 103,     ID: 28,     OD: 1,     roughness: 0.001 },
  { section: "Casing", size: '20"',       fromMD: 0,      toMD: 379.5,   ID: 18.73,  OD: 0.635, roughness: 0.001 },
  { section: "Casing", size: '13 3/8"',   fromMD: 0,      toMD: 1971.5,  ID: 12.347, OD: 0.514, roughness: 0.001 },
  { section: "Casing", size: '9 5/8"',    fromMD: 0,      toMD: 3341.5,  ID: 8.681,  OD: 0.472, roughness: 0.001 },
  { section: "Liner",   size: '7"',       fromMD: 3193.5, toMD: 3633.5, ID: 6.184,  OD: 0.408, roughness: 0.001 }
];

const tubingData = [
  { toMD: 3392.34, ID: 2.992, OD: 0.254, roughness: 0.001 }
];

const equipmentData = [
  { name: 'SSSV 3',     type: 'SSSV', MD: 158.9595, enabled: true },
  { name: 'Packer 1',   type: 'Pk 1', MD: 3315.4,    enabled: true }
];
...
const reservoirData = {
  ...
  resPressure: null,   // not provided in this record
  temperature: null,
  c: null,
  n: null,
  OGR: '',
